...
// a função abaixo gera um numero de 0 a 12 que diz respeito a uma das cartas da string constante simbolo
inline int numero_simbolo_aleatorio() { return std::rand() % 12; }

// a função abaixo gera um numero de 0 a 3 que diz respeito a uma das cartas da string constante simbolo
inline int numero_naipe_aleatorio() { return std::rand() % 3; }
...
bool IJogo::carta_repetida(char naipe, char simbolo)
{
    ...
    {
        /* Se o elemento do vector cartas usadas naipe for igual o naipe de entrada, 
        E o elemento do vector cartas usadas simbolos for igual o simbolo de entrada, então  retorna que a função é repetida */
        if (this->cartas_usadas_naipes[iteracao] == naipe && this->cartas_usadas_simbolos[iteracao] == simbolo)
        {
            return 1;
        }
